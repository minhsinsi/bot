...
if (!fs.existsSync(process.cwd() + '/Data_Vtuan')) {
    fs.mkdirSync(process.cwd() + '/Data_Vtuan');
    fs.writeFileSync(process.cwd() + '/Data_Vtuan/A_README.md', 'This folder is used by ChernobyL(NANI =)) ) to store data. Do not delete this folder or any of the files in it.', 'utf8');
}
var db = new BetterDB(process.cwd() + "/Data_Vtuan/SyntheticDatabase.sqlite");
